...
public class AddUserPage extends BasePage{
    ...
    private static By RoleTypeESS ;
    private static By enabledStatus ;
    ...
    private final By selectEmployeeName = By.xpath("(//div[@role='option'])[5]");
    ...
    public void clickOnESSRoleType(String text){
        RoleTypeESS=By.xpath("//div[@role='option' and .//span[normalize-space(text())=\""+text+"\"]]");
        findElement(RoleTypeESS).click();}
    public void clickOnEnabledStatus(String text){
        enabledStatus=By.xpath("//div[@role='option' and .//span[normalize-space(text())=\""+text+"\"]]");
        findElement(enabledStatus).click();}
    public void clickOnSelectEmplyeeName (){
        findElement(selectEmployeeName);
        findElement(selectEmployeeName).click();}
